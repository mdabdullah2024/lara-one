        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li><a class="btn btn-primary" href="{{url('/teacher/homework/homework')}}">Homework</a></li>
            </ol>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <a style="margin-top: 31px;" class="btn btn-success btn-sm" href="{{url('/teacher/homework/submitted_homework/'.$homework_id)}}"> Reset </a>
                    </div>
                </div>
              </div>
          </div>
