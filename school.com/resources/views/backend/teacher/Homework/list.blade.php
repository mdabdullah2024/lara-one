        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li><a class="btn btn-primary" href="{{url('/teacher/homework/homework/add')}}">Add New Homework</a></li>
            </ol>
          </div>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <a style="margin-top: 31px;" class="btn btn-success btn-sm" href="{{url('/teacher/homework/homework')}}"> Reset </a>
                    </div>
                </div>
              </div>
          </div>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr style="min-width: 300px;">
                      ...
                      <td>
                        <a title="Edit" href="{{  url('/teacher/homework/homework/edit/'.$value->id) }}" class="btn btn-success">Edit</a>
                        <a title="delete" href="{{  url('/teacher/homework/homework/delete/'.$value->id) }}" class="btn btn-danger">delete</a>
                        <a style="margin-top:10px;" title="Submitted Homework" href="{{  url('/teacher/homework/homework/submitted/'.$value->id) }}" class="btn btn-success">Submitted Homework</a>
