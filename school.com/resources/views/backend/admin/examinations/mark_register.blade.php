                ...
                <div class="row">
                  ...
                  <div class="col-md-3 ">
                    <div class="form-group">
                      ...
                      <a style="margin-top: 31px;" class="btn btn-success btn-sm" href="{{url('admin/examinations/mark_register/list')}}"> Reset </a>
                    </div>
                </div>
              </div>
          </div>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <div style="margin-top:10px;">
                                <button type="button" class="btn btn-primary saveSingleSubject" id="{{$student->id}}" data-subject="{{$subject->id}}" data-exam="{{ Request::get('exam_id')}}" data-class="{{ Request::get('class_id')}}" data-id="{{ $subject->id }}">Save One</button>
                              </div>
                            ...
                            <a target="_blank" href="{{ url('/admin/my_exam_result/print?exam_id='.Request::get('exam_id').'&student_id='.$student->id) }}" class="btn btn-success btn-sm">Print</a>
                            ...
                            <br>
                              @if(!empty($total_student_marks))
                                  ...
                                  <br>
                                    ...
                                    @if(!empty($getGrade))
                                      Grade: <span style="color: green;">{{ $getGrade }}</span>
                                    @endif
                                  <br>
                                  @if($pass_fail_vali == 0)
