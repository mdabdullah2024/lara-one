        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <!-- form start -->
              <form action="{{route('admin.subject.udate',$getRecord->id)}}" method="get">
                @csrf
                <div class="card-body">
                  <div class="form-group">
                    <label>Subject Name</label>
                    <input type="text" class="form-control form-control-sm" name="name" placeholder="Subject Name"  value="{{old('name',$getRecord->name)}}">
                  </div>
                  <div class="form-group">
