                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control form-control-sm" name="admission_date" placeholder="Date Of Birth"  value="{{old('admission_date')}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input  type="text" class="form-control form-control-sm" name="marital_status" placeholder="marital_status"  value="{{old('marital_status')}}">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="address" placeholder="Present Address" >{{old('address')}}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="permanent_address" placeholder="Permanent Address" >{{old('permanent_address')}}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="qualification" placeholder="Qualification" >{{old('qualification')}}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="work_experience" placeholder="Work Experience" >{{old('work_experience')}}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="note" placeholder="Note" >{{old('note')}}</textarea>
