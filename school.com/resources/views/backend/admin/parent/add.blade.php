                  ...
                  <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input  type="text" class="form-control form-control-sm" name="occupation" placeholder="occupation"  value="{{old('occupation')}}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea rows="6" cols=""  class="form-control form-control-sm" name="address" placeholder="Address" >{{old('address')}}</textarea>
