...
<div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>{{$header_title}} (<span style="color: blue;">{{ $getChild->name }} {{ $getChild->last_name }}</span>)</h1>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-header">
            <h3 class="card-title">Search My Child Homework</h3>
          </div>
          <form action="" method="get" enctype="multipart/form-data">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <a style="margin-top: 31px;" class="btn btn-success btn-sm" href="{{url('/parent/my-children/homework/'.$getChild->id)}}"> Reset </a>
                    </div>
                </div>
              </div>
          </div>
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">My Child Homework List</h3>
              </div>
              <!-- /.card-header -->
