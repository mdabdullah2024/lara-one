                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <div class="form-group">
                      ...
                      <a style="margin-top: 31px;" class="btn btn-success btn-sm" href="{{url('/student/my_homework')}}"> Reset </a>
                    </div>
                </div>
              </div>
          </div>
                ...
                <table class="table table-striped" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <a title="Homework Submit" href="{{ url('/student/my_homework_submit/'.$value->id) }}" class="btn btn-success btn-sm">Submit Homework</a>
                      </td>
                    </tr>
                    @empty
                    <tr>
