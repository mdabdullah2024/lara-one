          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                ...
                <a target="_blank" style="float:right;" href="{{ url('/student/my_exam_result/print?exam_id='.$value['exam_id'].'&student_id='.Auth::user()->id) }}" class="btn btn-success btn-sm">Print</a>
              </div>
              <!-- /.card-header -->
